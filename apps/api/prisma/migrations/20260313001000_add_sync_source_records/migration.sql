...
-- CreateIndex
CREATE UNIQUE INDEX "sync_source_records_customer_id_environment_id_source_source_id_key"
ON "sync_source_records"("customer_id", "environment_id", "source", "source_id");
