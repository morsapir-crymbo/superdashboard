  ...
  const fetchStats = useCallback(
    async (showLoading = false, recalculate = false) => {
      ...
      try {
        ...
        const volumeResponse = await api.get('/volume/stats', { signal });
        ...
        console.error('Volume API error:', {
          status: statusCode,
            ...
            <div className="flex items-center gap-4 sm:gap-5">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Deposit volume monitoring across all customers
                </p>
              </div>
            </div>
          ...
          {loading ? (
            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-8">
              <div className="text-center">
                ...
                <p className="text-red-700 font-semibold text-lg mb-2">Failed to load volume</p>
